...
#define ACTCUI_CVSTYLE_NO_OPERATIONS                                                   \
	(ACTCUI_CVSTYLE_NO_CUT | ACTCUI_CVSTYLE_NO_COPY | ACTCUI_CVSTYLE_NO_PASTE |        \
	 ACTCUI_CVSTYLE_NO_REFRESH | ACTCUI_CVSTYLE_NO_REMOVE | ACTCUI_CVSTYLE_NO_RENAME | \
	 ACTCUI_CVSTYLE_NO_PROPERTIES | ACTCUI_CVSTYLE_NO_HELP | ACTCUI_CVSTYLE_NO_VIEWOPTIONS)
...
#define ACTCUI_DDO_ACCEPT_ALL_ITEMS                                                       \
	(ACTCUI_DDO_ACCEPT_TOOL | ACTCUI_DDO_ACCEPT_STOCKTOOL | ACTCUI_DDO_ACCEPT_PALETTE |   \
	 ACTCUI_DDO_ACCEPT_PACKAGE | ACTCUI_DDO_ACCEPT_CATEGORY | ACTCUI_DDO_ACCEPT_CATALOG | \
...
public:
	...
	BOOL Create(DWORD dwWndStyle, DWORD dwCatalogViewStyle, const RECT& rect, CWnd* pParent,
...
protected:
	...
	virtual void OnBeginDrag(const CAcTcUiCatalogViewItemArray& itemsDragged,
							 IDataObject* pDataObject, DWORD dwKeyState);
