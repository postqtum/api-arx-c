...
constexpr int eGood = AcGe::eGood;
constexpr int eBad = AcGe::eBad;

using AcGeError = AcGe::ErrorCondition;
using AcGeIntersectError = AcGe::AcGeIntersectError;
using AcGeXConfig = AcGe::AcGeXConfig;
using EntityId = AcGe::EntityId;
using ExternalEntityKind = AcGe::ExternalEntityKind;
using KnotParameterization = AcGe::KnotParameterization;
using NurbSurfaceProperties = AcGe::NurbSurfaceProperties;
using PointContainment = AcGe::PointContainment;
